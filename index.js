...
/**
 * The function `executeBashCommandSync` executes a bash command synchronously and logs the command and
 * its output or error.
 */
...
/**
 * The `hack` function generates random activity for each day within a given date range, excluding
 * weekends, based on specified commit chances.
 */
const hack = () => {
...
/**
 * The function `handleEndDateResponse` handles the user's response for the end date and validates it.
 */
...
/**
 * The function `handleStartDateResponse` handles the user's response for the start date and prompts
 * for the end date if the start date is valid, otherwise it prompts for the start date again.
 */
